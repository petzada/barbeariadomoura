...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:flex-col md:max-w-[420px] pointer-events-none [&>*]:pointer-events-auto",
      className
    )}
    {...props}
  />
...
>(({ className, variant, children, ...props }, ref) => {
  return (
    ...
    >
      ...
      >
        <span className="block h-full w-full origin-left animate-[toast-progress_var(--toast-duration,4s)_linear_forwards] bg-[#EAD8AC]/70" />
      </span>
    </ToastPrimitives.Root>
  );
});
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border border-black bg-transparent px-3 text-sm font-medium text-[#EAD8AC] transition-colors hover:bg-[#EAD8AC] hover:text-[#013648] focus:outline-none focus:ring-2 focus:ring-[#EAD8AC] focus:ring-offset-2 focus:ring-offset-[#013648] disabled:pointer-events-none disabled:opacity-50",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1.5 text-[#EAD8AC]/70 opacity-100 sm:opacity-0 transition-opacity hover:text-[#EAD8AC] focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-[#EAD8AC] group-hover:opacity-100",
      className
    )}
    toast-close=""
    {...props}
