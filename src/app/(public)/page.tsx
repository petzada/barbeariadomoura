    ...
    return (
        <div className="min-h-screen bg-[#05384B] text-[#E4D0B0] flex flex-col">
            ...
            <div className="flex-1 flex flex-col px-6">
                ...
                <div className="flex-[0.8] flex items-center justify-center pb-8">
                    <div className="grid grid-cols-3 gap-3 w-full max-w-md">
                        <Link
                            href="/sobre/servicos"
                            className="flex flex-col items-center gap-1.5 p-3 rounded-lg bg-[#05384B]/50 border border-[#E4D0B0]/20 hover:border-[#E4D0B0]/60 transition-all"
                        >
                            <Scissors className="h-5 w-5 text-[#E4D0B0]" />
                            <span className="text-xs text-[#E4D0B0] font-medium">Serviços</span>
                        </Link>
                        <Link
                            href="/sobre/profissionais"
                            className="flex flex-col items-center gap-1.5 p-3 rounded-lg bg-[#05384B]/50 border border-[#E4D0B0]/20 hover:border-[#E4D0B0]/60 transition-all"
                        >
                            <Users className="h-5 w-5 text-[#E4D0B0]" />
                            <span className="text-xs text-[#E4D0B0] font-medium">Profissionais</span>
                        </Link>
                        <Link
                            href="/sobre/clube"
                            className="flex flex-col items-center gap-1.5 p-3 rounded-lg bg-[#05384B]/50 border border-[#E4D0B0]/20 hover:border-[#E4D0B0]/60 transition-all"
                        >
                            <Crown className="h-5 w-5 text-[#E4D0B0]" />
                            <span className="text-xs text-[#E4D0B0] font-medium">Clube</span>
                        </Link>
                    </div>
                </div>
            </div>
