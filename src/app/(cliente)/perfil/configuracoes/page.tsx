...
export default function ConfiguracoesPage() {
  ...
  async function handleDeleteAccount() {
    ...
    try {
      ...
      // Nota: A exclusão real da conta requer uma Edge Function no Supabase
      // por motivos de segurança. Por ora, vamos apenas fazer logout
      // e marcar a conta para exclusão (implementação futura)
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure como deseja receber lembretes
              </CardDescription>
            </CardHeader>
                          ...
                          <div className="flex items-start gap-2 p-3 rounded-lg bg-destructive/10 text-destructive">
                            ...
                            <div>
                              ...
                              <p className="text-sm mt-1">
                                Todos os seus dados, incluindo agendamentos e histórico,
